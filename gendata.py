...
# raw_data = pd.read_csv('data/Sigmod/X1.csv')
# ground = pd.read_csv('data/Sigmod/Y1.csv')
...
# output_df.to_csv('data/train_small.csv', index=False)
# output_df = pd.DataFrame(dev_set, columns=['left', 'right', 'score'])
# output_df.to_csv('data/dev_small.csv', index=False)
# output_df = pd.DataFrame(test_set, columns=['left', 'right', 'score'])
# output_df.to_csv('data/test_small.csv', index=False)
