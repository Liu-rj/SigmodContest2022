...
def handle(dataset: pd.DataFrame):
    """ Call clean_x2.py;
    ...
    # for u,u_index in unsolved_spec.copy():
    #     for s,s_index in solved_spec.copy():
    ...
    #                     solved_spec.append((u,u_index))
    #                     unsolved_spec.remove((u,u_index))
    #                     break
    ...
    #
    # clusters['0']=[]
    # for u,index in unsolved_spec:
    #     clusters['0'].append(index)
    #     if u['title'] in clusters.keys():
    #         clusters[u['title']].append(u['id'])
    #     else:
    #         clusters.update({u['title']: [u['id']]})
    #     features.append((instance_id,title,brand,pc_name,cpu_model,capacity,cpu_core,family,cpu_frequency,display_size))

    # return pd.DataFrame(features,columns=['instance_id','title','brand','pc_name','cpu_model','capacity','cpu_core','family','cpu_frequency','display_size'])
    return clusters
